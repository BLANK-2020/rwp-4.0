...
import { generateAnalyticsSummary } from '../../../../lib/openai'
import { getTenantByDomain } from '../../../../lib/tenants'
import payload from 'payload'

/**
 * API route for generating analytics summaries
 *
 * This endpoint generates an AI summary of analytics data for the current tenant.
...
export async function GET(req: NextRequest) {
  try {
    ...
    const summary = await generateAnalyticsSummary(analyticsData, tenant.name)
